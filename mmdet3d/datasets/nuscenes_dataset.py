...
# from .pipelines.rasterize import preprocess_map
...
class NuScenesDataset(Custom3DDataset):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            test_mode=test_mode,
            test_rainy=test_rainy,
            test_night=test_night,
        )
    ...
    def get_data_info(self, index: int) -> Dict[str, Any]:
        ...
        # data["gt_lane_seg"] = seg
        # data["gt_lane_ins"] = ins
        # data["gt_lane_dir"] = dir
    ...
    def onehot_encoding(self, logits, dim=1):
    ...
    #         intersects, union = self.get_batch_iou(
    #             semantic.unsqueeze(0).float().clamp(0,1).round(),
